...
public class MessageConstant {
    ...
    public static final String QUERY_CHECKITEMIds_FAIL = "查询检查项Ids失败";
    public static final String QUERY_CHECKITEMIds_SUCCESS = "查询检查项Ids成功";
    ...
    public static final String ORDER_FULL = "所选日期预约人数已满";
    ...
    public static final String EIDT_USER_SUCCESS = "修改用户信息成功";
    public static final String EIDT_USER_FALL = "修改用户信息失败";
    ...
    public static final String DELETE_USER_FALL = "删除用户失败";
    public static final String ADD_PERMISSION_SUCCESS = "新增权限成功";
    public static final String ADD_PERMISSION_FALL = "新增权限失败";
